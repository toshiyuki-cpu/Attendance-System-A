class UsersController < ApplicationController
  ...
  def user_params
    params.require(:user).permit(:name, :email, :affiliation, :employee_number, :password, :password_confirmation, :uid, :basic_work_time, :designated_work_start_time, :designated_work_end_time) # Storong Parameter
