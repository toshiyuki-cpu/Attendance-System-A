...
#  affiliation                :string
#  basic_time                 :datetime         default(Sun, 14 Feb 2021 08:00:00 JST +09:00)
#  basic_work_time            :datetime
#  designated_work_end_time   :datetime         default(Sun, 14 Feb 2021 18:00:00 JST +09:00)
#  designated_work_start_time :datetime         default(Sun, 14 Feb 2021 09:00:00 JST +09:00)
#  email                      :string
...
#  uid                        :string
#  work_time                  :datetime         default(Sun, 14 Feb 2021 07:30:00 JST +09:00)
...
class User < ApplicationRecord #Userモデル
  ...
  def self.import(file)
    CSV.foreach(file.path, headers: true) do |row|
      ...
      user.save #!(validate: false)バリデーションを通さずに保存する
    end
  end
